...
// SettingsNamespace is a runtime-validated lowercase kebab-case string in DSH
// 0.1.1-rc.2. Keep the literal here to avoid installing a second copy of the
// DSH settings service package just for its identity helper.
...
export const Config = z.object({
  ...
  token: z.string().pattern(/^(?:[A-Za-z0-9_-]{43}|)$/).role('secret').default(''),
})
